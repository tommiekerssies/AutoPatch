...
# local library
from lib.gaia.dynamic_bn import DynamicBatchNorm
from lib.gaia.dynamic_sync_bn import DynamicSyncBatchNorm
from lib.gaia.dynamic_naive_sync_bn import DynamicNaiveSyncBatchNorm
...
def build_norm_layer(cfg, num_features, postfix=""):
    ...
    if layer_type != "GN":
        ...
        if (layer_type == "SyncBN" or layer_type == "DynSyncBN") and hasattr(
            layer, "__specify_ddp_gpu_num"
        ):
