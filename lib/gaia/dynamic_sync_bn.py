...
class DynamicSyncBatchNorm(SyncBatchNorm, DynamicMixin):
    ...
    def __init__(
        ...
        super(DynamicSyncBatchNorm, self).__init__(
            num_features, eps, momentum, affine, track_running_stats, process_group
        )
    ...
    def forward(self, input):
        ...
        if not need_sync:
            ...
            #         "DynamicSyncBatchNorm is only supported \
